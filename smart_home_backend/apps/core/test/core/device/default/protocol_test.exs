defmodule Core.Device.Default.ProtocolTest do
  ...
  test "invoke encode" do
    ...
    assert Protocol.encode(0, 100, [50, 3, 2, 90, 100]) == [
             200,
             200,
             0,
             100,
  ...
  test "invoke decode" do
    assert Protocol.decode([200, 200, 0, 100, 0, 0, 0, 0, 0, 14, 200]) ==
             {:ok, [0, 100, 0, 0, 0, 0, 0]}
    ...
    assert Protocol.decode([200, 200, 0, 100, 0, 0, 0, 0, 0, 15, 200]) ==
             {:error, "invalid_control_sum"}
  end
end
